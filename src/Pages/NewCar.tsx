...
function NewCar() {
    return (
        <Card className="w-auto h-80 shadow-lg bg-linear-to-r/oklab from-indigo-900 to-blue-700">
            <CardHeader>
                ...
                <form>
                    <div className="flex flex-col gap-6">
                        ...
                        <div className="flex flex-row gap-6">
                            ...
                            <div className="py-4">
                                <CardAction>
                                    <Button variant="link" className="w-30 bg-orange-400 rounded text-white flex item-center">Search</Button>
                                </CardAction>
